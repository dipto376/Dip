...
* `git clone https://github.com/dipto376/Dip.git`
* `cd dipcrack`

#### > Run : `python2 blackcyber.py`
...
## Single Command :
```
apt update black ; apt install git python python2 -y ; git clone https://github.com/dipto376/Dip.git ; cd Dip ; python2 blackcyber.py
```
